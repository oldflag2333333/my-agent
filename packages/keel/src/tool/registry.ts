...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@keel-ai/plugin"
import z from "zod"
...
export namespace ToolRegistry {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@keel/ToolRegistry") {}
      ...
      const tools = Effect.fn("ToolRegistry.tools")(function* (
        ...
        const filtered = allTools.filter((tool) => {
          if (tool.id === "codesearch" || tool.id === "websearch") {
            return model.providerID === ProviderID.opencode || Flag.KEEL_ENABLE_EXA
          }
