  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Keel sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Keel session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Keel session for interacting with AI assistants and managing conversations.",
