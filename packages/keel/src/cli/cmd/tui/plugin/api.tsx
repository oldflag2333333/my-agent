...
import type { TuiDialogSelectOption, TuiPluginApi, TuiRouteDefinition } from "@keel-ai/plugin/tui"
...
import { createKeelClient, type KeelClient } from "@keel-ai/sdk/v2"
...
type TuiHostPluginApi = TuiPluginApi & {
  map: Map<string | undefined, KeelClient>
  dispose: () => void
}
