...
export namespace SessionPrompt {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@keel/SessionPrompt") {}
  ...
  export const layer = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const insertReminders = Effect.fn("SessionPrompt.insertReminders")(function* (input: {
        ...
        if (!Flag.KEEL_EXPERIMENTAL_PLAN_MODE) {
          ...
          while (true) {
            ...
            const outcome: "break" | "continue" = yield* Effect.onExit(
              Effect.gen(function* () {
                ...
                const [skills, env, packs, instructions, modelMsgs] = yield* Effect.promise(() =>
                  Promise.all([
                ...
                const system = SystemPrompt.compose({ env, packs, skills, instructions })
