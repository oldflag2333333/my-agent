...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders KEEL_CALLER", () => {
    process.env["KEEL_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode KEEL_CALLER", () => {
    process.env["KEEL_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown KEEL_CALLER", () => {
    process.env["KEEL_CALLER"] = "unknown"
