...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/anomalyco/keel.git")).toEqual({ owner: "anomalyco", repo: "keel" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/anomalyco/keel")).toEqual({ owner: "anomalyco", repo: "keel" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:anomalyco/keel.git")).toEqual({ owner: "anomalyco", repo: "keel" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:anomalyco/keel")).toEqual({ owner: "anomalyco", repo: "keel" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/anomalyco/keel.git")).toEqual({ owner: "anomalyco", repo: "keel" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/anomalyco/keel")).toEqual({ owner: "anomalyco", repo: "keel" })
})
