...
- Also apply locale-specific guidance from `.keel/glossary/<locale>.md` when available (for example, `zh-cn.md`).
...
.keel/agents/
.keel/commands/
.keel/commands/test.md
.keel/modes/
.keel/plans/*.md
.keel/plugins/
.keel/skills/<name>/SKILL.md
.keel/skills/git-release/SKILL.md
.keel/tools/
.well-known/opencode
...
%USERPROFILE%\.config\keel\keel.jsonc
%USERPROFILE%\.config\opencode\plugins
%USERPROFILE%\.local\share\opencode
%USERPROFILE%\.local\share\opencode\log
<project-root>/.keel/themes/*.json
<providerId>/<modelId>
<your-project>/.keel/plugins/
~
~/...
~/.agents/skills/*/SKILL.md
~/.agents/skills/<name>/SKILL.md
